...
public class PropertyServiceImpl implements PropertyService {
    ...
    @Override
    public void attachToMobile(Property propery, Mobile mobile) throws PropertyException {
    ...
    @Override
    public List<Property> getCreatureProperties() {

    }

    @Override
    public List<Property> getMobileProperties() {
